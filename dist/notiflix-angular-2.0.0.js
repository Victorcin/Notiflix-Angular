...
const notiflixIndicatorSvgStandard = function (width, color) {
    if (!width) { width = '60px'; }
...
const notiflixIndicatorSvgHourglass = function (width, color) {
    if (!width) { width = '60px'; }
    if (!color) { color = '#32c682'; }
...
const notiflixIndicatorSvgCircle = function (width, color) {
    if (!width) { width = '60px'; }
    if (!color) { color = '#32c682'; }
...
const notiflixIndicatorSvgArrows = function (width, color) {
    if (!width) { width = '60px'; }
    if (!color) { color = '#32c682'; }
...
const notiflixIndicatorSvgDots = function (width, color) {
    if (!width) { width = '60px'; }
    if (!color) { color = '#32c682'; }
...
const notiflixIndicatorSvgPulse = function (width, color) {
    if (!width) { width = '60px'; }
    if (!color) { color = '#32c682'; }
...
const notiflixIndicatorSvgNotiflix = function (width, white, green) {
    if (!width) { width = '60px'; }
    if (!white) { white = '#f8f8f8'; }
